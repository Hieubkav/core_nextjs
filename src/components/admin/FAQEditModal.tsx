...
export default function FAQEditModal({ faq, onClose, onSuccess }: FAQEditModalProps) {
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                <div className="text-xs text-gray-500 space-y-1">
                  ...
                  <p><strong>Tạo lúc:</strong> {formatDate(faq.createdAt)}</p>
                  <p><strong>Cập nhật:</strong> {formatDate(faq.updatedAt)}</p>
                </div>
              </div>
